...
{     
	public static SqlConnection ConnectToDb(string fileName)
    {
        ...
        string connString = @"Data Source=(LocalDB)\SchoolDB2019;AttachDbFilename=" + path + @";Initial Catalog=Database3;Integrated Security=True;Connect Timeout=30"; SqlConnection conn = new SqlConnection(connString);
            return conn;
	}
